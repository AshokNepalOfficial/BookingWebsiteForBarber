...
<div class="max-w-4xl">
    <form action="{{ route('admin.roles.store') }}" method="POST" class="bg-dark-900 rounded-lg border border-white/5 p-6">
        @csrf
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <div class="mt-4">
                    ...
                    <textarea name="description" rows="2" class="input-dark" placeholder="Brief description of this role">{{ old('description') }}</textarea>
                    @error('description')
                    <p class="text-red-400 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
